    ...
    public class Program
    {
        public static int Main(string[] args)
        {
            ...
            try
            {
                ...
                Samples.QueryRecycleBin objQueryRecycleBin = new Samples.QueryRecycleBin(connectionUrl, token, project);
                ...
                objQueryRecycleBin.QueryRecycleBinUsingClientLib();
